<?php
//
// This is the site-specific functions file for the PLACEHOLDER site. 
//
// These are the site-specific variables:
$sitecss = "PLACEHOLDER"; // Defines the site-specific stylesheet(s)
$sitejs = "PLACEHOLDER"; // Defines the site-specific javascript(s)
...
function the_sitecss()
{
  ...
  if (strcasecmp($GLOBALS['sitecss'], "PLACEHOLDER") == 0) {
    echo '<link rel="stylesheet" href="/css/PLACEHOLDER/main.css?version=1.0">' . PHP_EOL;
  } else {
...
function the_sitejs()
{
  ...
  if (strcasecmp($GLOBALS['sitejs'], "PLACEHOLDER") == 0) {
    include($_SERVER['DOCUMENT_ROOT'] . '/includes/PLACEHOLDER/site-js.php');
  } else {
