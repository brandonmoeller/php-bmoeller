<?php
//
// This is the site-specific functions file for the lab site. 
//
// These are the site-specific variables:
$sitecss = "lab"; // Defines the site-specific stylesheet(s)
$sitejs = "lab"; // Defines the site-specific javascript(s)
...
function the_sitecss()
{
  ...
  if (strcasecmp($GLOBALS['sitecss'], "lab") == 0) {
    echo '<link rel="stylesheet" href="/css/lab/main.css?version=1.0">' . PHP_EOL;
  } else {
...
function the_sitejs()
{
  ...
  if (strcasecmp($GLOBALS['sitejs'], "lab") == 0) {
    include($_SERVER['DOCUMENT_ROOT'] . '/includes/lab/site-js.php');
  } else {
